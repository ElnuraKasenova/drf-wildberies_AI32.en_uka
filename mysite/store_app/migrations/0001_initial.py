# Generated by Django 6.0.5 on 2026-05-22 18:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chose_size', models.CharField(choices=[('S', 'S'), ('M', 'M'), ('L', 'L'), ('XL', 'XL'), ('2XL', '2XL'), ('3XL', '3XL')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subcategory_name_ky', models.CharField(max_length=32, null=True)),
                ('subcategory_name_ru', models.CharField(max_length=32, null=True)),
                ('subcategory_name_en', models.CharField(max_length=32, null=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store_app.category')),
            ],
        ),
        migrations.AddField(
